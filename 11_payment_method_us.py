...
braintree = braintree[braintree['Shipping Country'] == 'United States of America'].copy()
...
sort_PIT = {'Credit Card' : 1, 'Apple Pay Card' : 2, 'PayPal Account' : 3, 'US Bank Account' : 4}
distinct_PIT = sorted(distinct_PIT, key = lambda instrument_type: sort_PIT[instrument_type])
